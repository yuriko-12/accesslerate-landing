  ...
  return (
    <main>
      <nav className="nav shell" aria-label="Navegación principal">
        <a className="brand" href="#top" aria-label="Accesslerate, inicio">ACCESSLERATE<span className="brand-mark">.</span></a>
